        ...
        <div className="section-container relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              />
              {/* Floating badge */}
              <div className="absolute -bottom-4 -right-4 z-20 bg-wect-blue text-white rounded-2xl px-5 py-4 shadow-glass border border-white/10">
                <div className="font-display font-black text-2xl leading-none">25+</div>
                <div className="font-body text-[11px] text-white/60 tracking-widest uppercase mt-0.5">Years of Excellence</div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-3">
                {features.map(({ icon: Icon, title, desc }) => (
                  <div key={title} className="flex items-start gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-wect-red-light/35 hover:bg-white/10 transition-all duration-200 group">
