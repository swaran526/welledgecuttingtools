...
export default function BottomCTA() {
  ...
  return (
    <section
      ref={ref}
      className="font-body bg-transparent py-8 sm:py-12 relative overflow-hidden"
    >
      <div className="section-container relative z-10">
        
        {/* Main CTA Card Container */}
        <div 
          className="border border-white/5 rounded-[2.5rem] shadow-glass relative overflow-hidden py-10 px-6 sm:px-8 lg:py-16 lg:px-12"
